...
namespace Vastcore.Generation.Map
{
    ...
    public class GeologicalLayer
    {
        ...
        public UnityEngine.Color layerColor;
        public float hardness;
        public UnityEngine.Vector3 deformation;         // 構造変形
        ...
        public GeologicalLayer(RockFormationType type, float thick, float geologicalAge)
        {
            ...
            deformation = UnityEngine.Vector3.zero;
            isFaulted = false;
        }
        ...
        private UnityEngine.Color GenerateLayerColor(RockFormationType type)
        {
            return type switch
            {
                RockFormationType.Sedimentary => new UnityEngine.Color(0.8f, 0.7f, 0.5f, 1f),    // 砂岩色
                RockFormationType.Igneous => new UnityEngine.Color(0.3f, 0.3f, 0.3f, 1f),        // 玄武岩色
                RockFormationType.Metamorphic => new UnityEngine.Color(0.5f, 0.4f, 0.6f, 1f),    // 片麻岩色
    ...
    /// </summary>
    public class GeologicalFormationGenerator : UnityEngine.MonoBehaviour
    {
        [Header("地質学的設定")]
        ...
        public GeologicalFormation SimulateFormationProcess(UnityEngine.Vector3 position, float simulationTime)
        {
        ...
        private void ProcessSedimentaryFormation(GeologicalLayer layer)
        {
            ...
            {
                // 深海堆積
                layer.layerColor = new UnityEngine.Color(0.4f, 0.4f, 0.5f, 1f); // 深海泥岩
                layer.hardness *= 0.8f;
            }
            else if (currentEnvironment.waterDepth > 10f)
            {
                // 浅海堆積
                layer.layerColor = new UnityEngine.Color(0.7f, 0.6f, 0.4f, 1f); // 石灰岩
                layer.hardness *= 1.2f;
            }
            else
            {
                // 陸上堆積
                layer.layerColor = new UnityEngine.Color(0.8f, 0.5f, 0.3f, 1f); // 砂岩
            }
        ...
        private void ProcessIgneousFormation(GeologicalLayer layer)
        {
            ...
            {
                // 火山岩
                layer.layerColor = new UnityEngine.Color(0.2f, 0.2f, 0.2f, 1f); // 玄武岩
                layer.hardness *= 1.3f;
            ...
            {
                // 深成岩
                layer.layerColor = new UnityEngine.Color(0.6f, 0.6f, 0.6f, 1f); // 花崗岩
                layer.hardness *= 1.5f;
        ...
        private void ProcessMetamorphicFormation(GeologicalLayer layer)
        {
            ...
            if (formationLayers.Count > 0)
            {
                ...
                {
                    case RockFormationType.Sedimentary:
                        layer.layerColor = new UnityEngine.Color(0.5f, 0.4f, 0.3f, 1f); // 片麻岩
                        break;
                    case RockFormationType.Igneous:
                        layer.layerColor = new UnityEngine.Color(0.3f, 0.5f, 0.4f, 1f); // 角閃岩
                        break;
                }
            ...
            layer.deformation = new UnityEngine.Vector3(
    ...
    public class GeologicalFormation
    {
        ...
        public GeologicalFormation(UnityEngine.Vector3 pos)
        {
            position = pos;
        ...
        public void AddLayer(GeologicalLayer layer)
        {
            layers.Add(layer);
        ...
        public GeologicalLayer GetTopLayer()
        {
            return layers.Count > 0 ? layers[layers.Count - 1] : null;
        }

        public GeologicalLayer GetBottomLayer()
        {
