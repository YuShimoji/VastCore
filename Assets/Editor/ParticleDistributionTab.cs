...
namespace Vastcore.Editor.Generation
{
    ...
    /// </summary>
    public class ParticleDistributionTab
    {
        ...
        private AdvancedStructureTab.MonumentType monumentType = AdvancedStructureTab.MonumentType.GeometricMonolith;
        ...
        public void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("Particle Distribution System", EditorStyles.boldLabel);
        ...
        private void DrawStructureSettings()
        {
            ...
            if (prefabToDistribute == null)
            {
                ...
                monumentType = (AdvancedStructureTab.MonumentType)EditorGUILayout.EnumPopup("Monument Type", monumentType);
            }
        ...
        {
            GameObject parentObject = new GameObject("Distributed Structures");
            ...
            for (int i = 0; i < positions.Count; i++)
            {
                ...
                if (prefabToDistribute != null)
                {
                    instance = GameObject.Instantiate(prefabToDistribute);
                }
                else
                {
                    // 記念碑タイプに基づいて生成
                    instance = CreateMonumentInstance(monumentType);
                }
        ...
        private GameObject CreateMonumentInstance(AdvancedStructureTab.MonumentType type)
        {
