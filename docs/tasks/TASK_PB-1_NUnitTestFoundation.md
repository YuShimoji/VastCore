...
Report: docs/inbox/REPORT_PB-1_NUnitTestFoundation.md
Milestone: MG-1
...
## DoD
- [x] EditMode テストディレクトリ/クラスが作成されている
- [x] `Vastcore.Testing.asmdef` が必要参照を満たしている
- [x] `VastcoreIntegrationTestStubs.cs` の扱いを明確化（置換 or 正式モック）
- [x] Unity Editor でコンパイル成功
- [x] EditMode テスト結果を `class=result` 形式で記録
- [x] `docs/inbox/REPORT_PB-1_*.md` を作成し Report 欄に反映
