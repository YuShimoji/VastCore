...
- [ ] Map of usage for both namespaces created.
- [ ] Unification plan approved (if unification is decided).
- [ ] Code refactored to use a single namespace (or distinct ones if justified).
- [ ] Compilation passes.
