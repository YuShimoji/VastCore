...
- [x] StructureTagProfile の PropertyDrawer (タグ一覧 + 重みスライダー + 既知タグドロップダウン)
- [x] StructureTagPreset の Custom Inspector (プレビュー + BlendScore比較)
- [x] AdjacencyRuleSet の Custom Inspector (マトリクス表示 + 色分け + Raw List)
